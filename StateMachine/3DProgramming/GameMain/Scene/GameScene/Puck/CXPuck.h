...
public:
	...
	*/
	...
	bool ColReflect(CVector3 &v0, CVector3 &v1, CVector3 &v2, CVector3 &fwd, float &radius, CVector3 &position, CVector3 *rtn);
	/*当たったとき動きを止める*/
	...
	*/
	...
	bool Collision(const COBB &box, const CColSphere &sphere, bool flgAjust);
	bool Collision(CTask *Puck, CTask *Task_You);
