...
//	CTaskManager mMapTaskManager;//マップのタスクマネージャー
	...
	public:
		...
		CTile(CVector3 pos,CTexture &t){
			...
			mpColTriangle[0] = new CColTriangle2();
			mpColTriangle[1] = new CColTriangle2();

			mpColTriangle[0]->Init(this, v0 + mPos, v1 + mPos, v3 + mPos, CVector3(), NULL);
			mpColTriangle[1]->Init(this, v1 + mPos, v2 + mPos, v3 + mPos, CVector3(), NULL);

//			CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, mpColTriangle[0]);
//			CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, mpColTriangle[1]);
		...
		void Update() {
//			mColTriangle[0].Update();
//			mColTriangle[1].Update();
		}
...
#ifdef _DEBUG
//			mpColTriangle[0]->Render();
//			mpColTriangle[1]->Render();
#endif
		}
	};
	...
	*/
	...
	CColTriangle2 *mpColTriangle2[8];
