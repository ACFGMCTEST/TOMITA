...
//ポリゴンサイズ
#define TITLELOGO_SIZE	RECT_SIZE(0.8f,TEX_TITLE_X,TEX_TITLE_Y) 
#define PUSH_KEY_SIZE	RECT_SIZE(1,TEX_PUSH_X,TEX_PUSH_Y) 
#define CURSOR_SIZE		RECT_SIZE(0.1f,TEX_CURSOR_X,TEX_CURSOR_Y)
/*ポリゴンのポジション*/
