...
/*地面サイズ*/
#define GROUND_SIZE CVector3(MAPCHIP_SIZE*CMap::mMapX, MAPCHIP_SIZE*2, MAPCHIP_SIZE * CMap::mMapZ)
...
#define OBB_BOX_SIZE CVector3(MAPCHIP_SIZE, MAPCHIP_SIZE, MAPCHIP_SIZE)
#define OBB_BOX_GOAL_SIZE CVector3(MAPCHIP_SIZE, MAPCHIP_SIZE, MAPCHIP_SIZE) 
/*網設定*/
...
/*あたり判定:壁の設定*/
/*サイズ*/
#define OBB_WALL_RIGHT_SIZE CVector3(MAPCHIP_SIZE, MAPCHIP_SIZE*10, MAPCHIP_SIZE*CMap::mMapZ*1.2f)
#define OBB_WALL_LEFT_SIZE	CVector3(MAPCHIP_SIZE, MAPCHIP_SIZE*10, MAPCHIP_SIZE*CMap::mMapZ*1.2f) 
#define OBB_WALL_UP_SIZE	CVector3(MAPCHIP_SIZE*CMap::mMapX*1.2f, MAPCHIP_SIZE*10, MAPCHIP_SIZE) 
#define OBB_WALL_DOWN_SIZE	CVector3(MAPCHIP_SIZE*CMap::mMapX*1.2f, MAPCHIP_SIZE*10, MAPCHIP_SIZE) 
/*向き*/
...
//			mMapTaskManager.Add(tile);//追加
			CTaskManager::GetInstance()->Add(tile);//追加
...
//				mMapTaskManager.Add(slowFloor);
			...
			case CMap::E_SLOP_C:
			case CMap::E_SLOP_D:
				slope = new CSlope(ARRAY_POS(x, 0, z), x, z, mCsvMapData.mpData[(z*mMapX) + x]);
...
#define NORMAL(vec) mObb.mNormal = CVector3(vec); //法線の向き
	...
	CColTriangle2 *p1 = new CColTriangle2();
	CColTriangle2 *p2 = new CColTriangle2();
	//MAPCHIP_SIZE*CMap::mMapX, MAPCHIP_SIZE*2, MAPCHIP_SIZE * CMap::mMapZ
	p1->Init(NULL,
		CVector3(MAPCHIP_SIZE*CMap::mMapX, 0.0f, MAPCHIP_SIZE * CMap::mMapZ),
		CVector3(MAPCHIP_SIZE*CMap::mMapX, 0.0f, -MAPCHIP_SIZE * CMap::mMapZ),
		CVector3(-MAPCHIP_SIZE*CMap::mMapX, 0.0f, MAPCHIP_SIZE * CMap::mMapZ), CVector3(), NULL);
	p2->Init(NULL,
		CVector3(-MAPCHIP_SIZE*CMap::mMapX, 0.0f, MAPCHIP_SIZE * CMap::mMapZ),
		CVector3(MAPCHIP_SIZE*CMap::mMapX, 0.0f, -MAPCHIP_SIZE * CMap::mMapZ),
		CVector3(-MAPCHIP_SIZE*CMap::mMapX, 0.0f, -MAPCHIP_SIZE * CMap::mMapZ), CVector3(), NULL);

	//CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, p1);
	//CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, p2);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, p1);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, p2);
...
//	mpColPlane[E_WALL_RIGHT]->NORMAL(VEC_LEFT);//法線を左に(パックの跳ね返り方向)
	mpColPlane[E_WALL_RIGHT]->NORMAL(VEC_RIGHT);//法線を左に(パックの跳ね返り方向)
//	CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, mpColPlane[E_WALL_RIGHT]);
	/*左の壁設定*/
...
//	mpColPlane[E_WALL_LEFT]->NORMAL(VEC_RIGHT);//法線を右に(パックの跳ね返り方向)
	mpColPlane[E_WALL_LEFT]->NORMAL(VEC_LEFT);//法線を右に(パックの跳ね返り方向)
//	CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, mpColPlane[E_WALL_LEFT]);
	/*上の壁設定*/
...
//	CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, mpColPlane[E_WALL_UP]);
	/*下の壁設定*/
...
//	CCollisionManager::GetInstance()->Add(CTask::E_TAG_GROUND, mpColPlane[E_WALL_DOWN]);

	//WALL_SIZE_LEFT, -WALL_SIZE_RIGHT,WALL_SIZE_TOP, WALL_SIZE_BOTTOM, WALL_SIZE_FRONT, -WALL_SIZE_BACK
	//Front
	mpColTriangle2[0] = new CColTriangle2();
	mpColTriangle2[0]->Init(NULL
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, WALL_SIZE_FRONT)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[0]);
	mpColTriangle2[1] = new CColTriangle2();
	mpColTriangle2[1]->Init(NULL
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, WALL_SIZE_FRONT)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_BOTTOM, WALL_SIZE_FRONT)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[1]);
	//Left
	mpColTriangle2[2] = new CColTriangle2();
	mpColTriangle2[2]->Init(NULL
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_TOP, -WALL_SIZE_BACK)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[2]);
	mpColTriangle2[3] = new CColTriangle2();
	mpColTriangle2[3]->Init(NULL
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, WALL_SIZE_FRONT)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[3]);
	//Right
	mpColTriangle2[4] = new CColTriangle2();
	mpColTriangle2[4]->Init(NULL
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, -WALL_SIZE_BACK)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[4]);
	mpColTriangle2[5] = new CColTriangle2();
	mpColTriangle2[5]->Init(NULL
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_BOTTOM, WALL_SIZE_FRONT)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, WALL_SIZE_FRONT)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[5]);
	//Back
	mpColTriangle2[6] = new CColTriangle2();
	mpColTriangle2[6]->Init(NULL
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, -WALL_SIZE_BACK)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_TOP, -WALL_SIZE_BACK)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[6]);
	mpColTriangle2[7] = new CColTriangle2();
	mpColTriangle2[7]->Init(NULL
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3(WALL_SIZE_LEFT, WALL_SIZE_BOTTOM, -WALL_SIZE_BACK)
		, CVector3(-WALL_SIZE_RIGHT, WALL_SIZE_TOP, -WALL_SIZE_BACK)
		, CVector3()
		, NULL);
	CCollisionManager::GetInstance()->Add(CTask::E_TAG_WALL, mpColTriangle2[7]);
